...
abstract contract ArtlinxTransferManager is OwnableUpgradeable, ITransferManager {
    ...
    function __ArtlinxTransferManager_init_unchained(
        uint newProtocolFee,
    ...
    function doTransfersWithFees(
        ...
        // sell no pay fee
        totalAmount = calculateTotalAmount(amount, 0, dataCalculate.originFees);
